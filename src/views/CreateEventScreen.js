    ...
    <div className="create_event_main">
      <div className="create_form-container">
        <form className="create_event_form" onSubmit={createEventHandler}>
          ...
          <div className="formRow">
            <div className="inline-block right-margin">
              <label htmlFor="startdate" className="textlabel datepick textlabel">
                Starting date
              </label>
              <SelectDateFrom
                required
            ...
            <div className="inline-block responsive right-margin">
              <label htmlFor="endDate" className="textlabel datepick textlabel">
                Closing date
              </label>
              <SelectDateTo
                required
          ...
          <div className="formRow">
            <div className="inline-block right-margin">
              <label htmlFor="user_limit" className="textlabel" id="particip_textlabel">
